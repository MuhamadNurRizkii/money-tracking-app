    ...
    >
        ...
        <div className="relative z-10">
          <div className="mb-8">
            <button 
              ...
              className="mb-4 text-sm font-medium text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors flex items-center gap-2"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Submit */}
            <div className="pt-4 mt-8 border-t border-gray-100 dark:border-gray-800 flex flex-col sm:flex-row gap-4">
              <button
                type="submit"
                className="w-full sm:w-auto sm:px-8 bg-gradient-brand text-white font-medium py-3 rounded-xl 
              ...
              <button
                type="button"
                onClick={() => navigate('/dashboard/transactions')}
                className="w-full sm:w-auto sm:px-8 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-medium py-3 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-200"
                disabled={submitting}
              >
                Batal
              </button>
      ...
      {showAlert && (
        ...
        >
          ...
          <span className="font-semibold">Transaski berhasil diupdate</span>
        </motion.div>
      )}
    </motion.div>
  );
